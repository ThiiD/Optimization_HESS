...
plt.figure(figsize=(fig_width_cm, fig_height_cm*.75))
plt.plot(df["Unnamed: 0"], df["VPL [R$]"], marker = "X", markersize = 12, color = "black", linewidth = 2, label = "VPL [R\$]")
plt.plot(df_otimo["Unnamed: 0"], df_otimo["VPL [R$]"], marker = "o", markersize = 10, color = "tab:red", linewidth = 2, linestyle ="dashed", label = "VPL [R\$] - Configuração Ótima")
plt.legend()
plt.xlabel("Id.")
